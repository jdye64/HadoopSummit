#!/bin/bash
SLEEP_SEC="40"
HDP_IMAGE_NAME="jdye64/hadoopsummit:summit_winifi"
...
CONTAINER_ID=$(docker ps | grep jdye64/hadoopsummit:summit_winifi | awk '{ print $1 }')
...
CONTAINER_ID=$(docker run -t -d -p 9898:9898 -h winifi.dev $HDP_IMAGE_NAME)
...
NIFI_URL="http://$IP_ADDR:9898/nifi"
